...
namespace CAS.UA.Server.ServerConfiguration
{
  ...
  public class CASConfiguration : ApplicationConfiguration
  {
    ...
    internal void Save(FileInfo configurationFile)
    {
      ...
      CASExtension.OPCDAClient.SetBaseDirectoryFilePath(_baseDirectory);
      CASExtension.CommServer.SetBaseDirecotryFilePath(_baseDirectory);
  ...
  {
    #region creators and initialization
    ...
    #endregion creators and initialization
