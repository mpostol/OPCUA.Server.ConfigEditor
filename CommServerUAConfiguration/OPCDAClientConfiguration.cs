//<summary>
//  Title   : Instance of this class is to be used to manage configuration of the OPC Client.
...
namespace CAS.UA.Server.ServerConfiguration
{
  ...
  public class OPCDAClientConfiguration
  {
    ...
    public string FileStatus { get { return Main.EntryPoint.OPCDAClienteEntryPoint.FileStatus; } }
    #endregion
    ...
    private class ConfigurationFileNameEditor: FileNameEditor
    {
      ...
      private void openFileDialog_FileOk( object sender, CancelEventArgs e )
      {
        ...
        Main.EntryPoint.OPCDAClienteEntryPoint.Open( parent.FileName, out resultinfo );
    ...
    private string GetRelativePath( string filename )
    {
      ...
      if ( string.IsNullOrEmpty( this.m_BaseDirectoryFilePath ) )
        ...
        filename = RelativeFilePathsCalculator.TryComputeRelativePath( this.m_BaseDirectoryFilePath, filename );
      return filename;
    }
